            ...
            <div class="footer-content">
                ...
                <div class="footer-section">
                    ...
                    <ul>
                        ...
                        <li><a href="<?= BASE_URL ?>/villes"><i class="fas fa-chevron-right"></i>Villes sinistrées</a></li>
                        <li><a href="<?= BASE_URL ?>/besoins"><i class="fas fa-chevron-right"></i>Besoins</a></li>
                        <li><a href="<?= BASE_URL ?>/donsAffichage"><i class="fas fa-chevron-right"></i>Dons</a></li>
    ...
    <!-- Custom JS -->
    <script src="<?= BASE_URL ?>/assets/js/fichier.js"></script>
</body>
</html>